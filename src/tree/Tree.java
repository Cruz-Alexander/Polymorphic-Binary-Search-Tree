...
public interface Tree<K extends Comparable<K>, V> {
     ...
     * @return -- value associated with the key by this Tree, or null if the key does not have an association in this tree.
     */
    V search(K key);

    /**
     * Insert/update the Tree with a new key:value pair. If the key already exists in the tree,
     * update the value associated with it. If the key doesn't exist, insert the new key value pair.
     * <p>
     * This method returns a reference to a Tree that represents the updated value.
    ...
    /**
     * Return the number of keys that are bound in this tree.
     *
     ...
     *
     * @param c Collection to add keys to
     */
    ...
    /**
     * Returns the height (maximum level) in the tree. A tree with only one entry has a height of 1.
     *
     ...
     * @param p object defining task
     */
    void rightRootLeftTraversal(TraversalTask<K, V> p);
}
